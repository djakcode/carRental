...
const Hero = () => {
  ...
  return (
    <div className="h-screen flex flex-col items-center justify-center gap-14 bg-light text-center">
      ...
      <form className="flex flex-col md:flex-row items-start md:items-center justify-between p-6 rounded-lg md:rounded-full w-full max-w-80 md:max-w-200 bg-white shadow-[0px_8px_20px_rgba(0, 0, 0, 0.1)]">
        <div className="flex flex-col md:flex-row items-start md:items-center gap-10 min-md:ml-8">
          <div className="flex flex-col items-start gap-2">
            ...
            >
              <option value="">Lieu de Prise en Charge</option>
              {cityList.map((city) => (
          ...
          <div className="flex flex-col items-start gap-2">
            <label htmlFor="pickup-date">Date de Depart</label>
            <input
              type="date"
              id="pickup-date"
      ...
      <img src={assets.main_car} alt="Voiture" className="max-h-74" />
    </div>
  );
};
